...
$username = "srisriem_ssuimun";
$password = "Guruji@12345";
$dbname = "srisriem_ssuimun";
...
if ($conn->query($sql) === TRUE) {
   echo header("Location: https://www.payumoney.com/paybypayumoney/#/7DCF4A9A064A89463EA41826EFB39670");
exit();
} else {
